# Project 2 - Flicker Movie App

Flicker Movie App shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
![Walkthrough](FlicksGif.gif)

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Briefly had issues with Glide API not being the same as the walkthrough, and with the rounded corners syntax being different.
